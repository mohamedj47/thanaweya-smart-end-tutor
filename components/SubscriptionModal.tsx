...
export const SubscriptionModal: React.FC = () => {
  ...
  const handleWhatsAppClick = () => {
    const message = `مرحباً مستر، أريد تفعيل اشتراك تطبيق 'المعلم الذكي'.%0aرقم جهازي هو: ${deviceId}%0aلقد قمت بتحويل مبلغ الاشتراك (حدد: مادة 100ج / باقة 400ج).`;
    ...
    <div className="fixed inset-0 z-[100] bg-slate-900/95 backdrop-blur-md flex items-center justify-center p-4 font-sans dir-rtl text-right" dir="rtl">
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden border border-slate-200 animate-in zoom-in-95 duration-300 relative">
        ...
        <div className="bg-gradient-to-r from-red-50 to-white p-5 text-center border-b border-red-100">
           ...
           <p className="text-sm text-slate-600 font-medium mt-1">استثمر في مستقبلك واشترك الآن</p>
        </div>
        ...
        <div className="p-5 space-y-5">
           ...
           <div className="bg-indigo-50/50 p-4 rounded-2xl border border-indigo-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                 {/* Single Subject */}
                 <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm text-center hover:border-indigo-300 transition-colors">
                 ...
                 {/* Full Bundle */}
                 <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-4 rounded-xl shadow-md text-center text-white relative overflow-hidden transform hover:scale-105 transition-transform duration-200">
