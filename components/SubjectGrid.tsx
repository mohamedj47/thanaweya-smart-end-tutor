...
import { 
  ...
  Scale, BrainCircuit, Activity, BookType, Dna, ScrollText, Flag 
} from 'lucide-react';
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
      {displayedSubjects.map((subject) => (
        <button
          ...
          className="glass-card p-6 rounded-2xl flex flex-col items-center justify-center gap-4 group text-center h-40 relative overflow-hidden"
        >
          ...
          <div className="w-16 h-16 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-white group-hover:scale-110 transition-all duration-300 shadow-sm">
